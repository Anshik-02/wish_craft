...
export default function BirthdaySong2() {
  return (
    <section className="w-full px-1 md:mt-24  mb-20 flex justify-center">
      <div className="max-w-3xl w-full bg-[#FFF1EB] rounded-3xl 
                      shadow-[0_20px_60px_rgba(0,0,0,0.08)] 
                      p-8 md:p-12 text-center">
        <h2 className="text-3xl md:text-4xl font-semibold text-[#E5989B] mb-4">
          A Song For You
        </h2>
